...
if(isset($_POST['update'])) {
	...
	if(!strlen($description)>0) {
        ...
        {
        	$upd_qry="update terms_and_conditions set content = '$description' where id = 1";
        	$run_qry=mysqli_query($dblink,$upd_qry);
        	if($run_qry){
        		echo '<script> success_message("","success","Terms and Conditions information Updated Successfully","terms_and_conditions.php"); </script>';
        	}
        	else{
...
list($terms) = exc_qry("select * from terms_and_conditions");            
?>
				...
				<div class="col-md-12">
					<div class="panel panel-default card-view">
						<div class="panel-heading">
							<div class="pull-left">
								<h6 class="panel-title txt-dark">Terms and Conditions</h6>
							</div>
											...
											<form method="post">
												<div class="form-group">
													<div class="input-group">
														...
														<textarea id="myeditor" type="text" name="description"  class="form-control" ><?php echo $terms[0]['content']; ?></textarea>
													</div>
												</div>
