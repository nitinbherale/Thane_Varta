...
if(isset($_POST['update'])) {
	...
	if(!strlen($description)>0) {
        ...
        {
        	$upd_qry="update privacy set content = '$description' where id = 1";
        	$run_qry=mysqli_query($dblink,$upd_qry);
        	if($run_qry){
        		echo '<script> success_message("","success","Privacy content Updated Successfully","privacy.php"); </script>';
        	}
        	else{
...
list($privacy) = exc_qry("select * from privacy");            
?>
				...
				<div class="col-md-12">
					<div class="panel panel-default card-view">
						<div class="panel-heading">
							<div class="pull-left">
								<h6 class="panel-title txt-dark">Privacy</h6>
							</div>
											...
											<form method="post">
												<div class="form-group">
													<div class="input-group">
														...
														<textarea id="myeditor" type="text" name="description"  class="form-control" ><?php echo $privacy[0]['content']; ?></textarea>
													</div>
												</div>
